...
module.exports = {
  ...
  node:null,
  pu:200,
  capability: 'week_program_celsius_temp',
  ...
  startReport:function(device){
    device.registerCapabilityListener(this.capability,
        async (payload) => { 
          ...
          console.log('week_program_celsius_temp SET:', payload, runModeCapValue); 
  ...
  setConfig:function(device, payload){
    console.log('week_program_celsius_temp SET:', payload); 
